...
# Adapted from https://github.com/philtabor/Youtube-Code-Repository/blob/master/ReinforcementLearning/PolicyGradient/actor_critic/actor_critic_replay_torch.py
...
class Agent():
    ...
    def choose_action(self, observation, task_encoding):
