...
class SimpleForwardTask(task_interface.Task):
  ...
  def reward(self, env):
    ...
    # reward = self._step_count * .001 * velocity #inentivizing the thing to stay upright as much as possible

    # reward += 0.001 * (-current_base_position[1])
